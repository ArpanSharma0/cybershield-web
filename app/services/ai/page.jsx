          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted max-w-xl leading-relaxed">
                Automate workflows, build AI agents, and scale business intelligence.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                {[
                  { title: "Agentic AI & Autonomous Workflows", desc: "Complex, multi-agent reasoning systems that execute intelligent, multi-step business tasks without human intervention." },
                  { title: "Enterprise Workflow Automation", desc: "Integrating disparate business software via custom machine learning pipelines to eliminate operational bottlenecks." },
                  { title: "Conversational Intelligence Engines", desc: "Context-aware, RAG-powered assistants that resolve tier-1 support autonomously and drive complex sales logic." },
                  { title: "Custom LLM Fine-Tuning & Deployment", desc: "Secure, on-premise or cloud-hosted proprietary language models trained exclusively on your specific enterprise data." }
                ].map((item, i) => (
