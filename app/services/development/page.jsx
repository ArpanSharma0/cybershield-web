          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted max-w-xl leading-relaxed">
                Fast, scalable, and modern digital products engineered to perform.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                {[
                  { title: "Enterprise Web Application Engineering", desc: "High-availability, microservices-driven digital products built on React, Node.js, and modern serverless architectures." },
                  { title: "Native & Cross-Platform Mobile Apps", desc: "Fluid, high-performance iOS and Android applications utilizing React Native and Swift, optimized for minimal latency." },
                  { title: "Scalable SaaS Product Development", desc: "End-to-end product engineering—from MVP to complex, multi-tenant architectures capable of handling millions of requests." },
                  { title: "Cloud Infrastructure & API Design", desc: "Secure, low-latency backend systems deployed on AWS/GCP with robust CI/CD pipelines and zero-downtime deployments." }
                ].map((item, i) => (
